...
CombinationParameterSearch(
	LocalSequentialBackend( num_threads=8 ),
	{
        ...
        # 'pgn.LGN_PGN_ConnectionOn.weight_functions.f1.params.arborization_constant': [75], # model A of feedback: 75
        ...
        # 'pgn.PGN_LGN_ConnectionOn.weight_functions.f1.params.arborization_constant': [50, 100, 150, 200, 250], # model A of feedback: 150
        # 'pgn.PGN_LGN_ConnectionOn.weight_functions.f1.params.arborization_constant': [130, 150, 170], # model A of feedback: 150
        ...
        'l4_cortex_exc.EfferentConnection_LGN.weight_functions.f1.params.arborization_constant': [5, 30, 360, 600], # model A of feedback: 60
        ...
        # 'l4_cortex_exc.EfferentConnection_PGN.weight_functions.f1.params.arborization_constant': [150, ], # model A of feedback: 90 
        # 'l4_cortex_exc.EfferentConnection_PGN.weight_functions.f1.params.arborization_constant': [90, 100, 180], # model A of feedback: 90 
  	}
