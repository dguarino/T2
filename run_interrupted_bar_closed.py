...
from experiments import create_experiment_interrupted_bar
...
# Model execution
data_store,model = run_workflow('ThalamoCorticalModel', ThalamoCorticalModel, create_experiment_interrupted_bar )
data_store.save()
