...
# or only load pickled data
    ...
    setup_logging()
    data_store = PickledDataStore(load=True,parameters=ParameterSet({'root_directory':'ThalamoCorticalModel_data_temporal_closed_____', 'store_stimuli' : False}),replace=True)
