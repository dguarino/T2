...
CombinationParameterSearch(
	LocalSequentialBackend( num_threads=8 ),
	{
        ...
        'pgn.PGN_LGN_ConnectionOn.weight_functions.f1.params.arborization_constant': [130, 140, 150, 160, 170], # model A of feedback: 150
        ...
        'l4_cortex_exc.EfferentConnection_PGN.weight_functions.f1.params.arborization_constant': [70, 80, 90, 100, 110], # model A of feedback: 90 
        # 'l4_cortex_exc.EfferentConnection_PGN.weight_functions.f1.params.arborization_constant': [70, 90, 110], # model A of feedback: 90 
  	}
