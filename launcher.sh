...
# echo "starting Size"
# echo
# mpirun -np 1 python run_size_closed.py nest 8 param/defaults_mea 'data_size_Yves'
...
mpirun -np 1 python run_orientation_feedforward.py nest 8 param/defaults_mea 'data_orientation_ffw'
