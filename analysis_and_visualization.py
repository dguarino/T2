...
def plot_size_tuning( data_store, analog_Xon_ids, analog_Xoff_ids, analog_PGN_ids=None, analog_ids=None ):
    ...
    if analog_PGN_ids:
        ...
        PlotTuningCurve(
            ...
            ParameterSet({
                ...
                'mean': False,
                'parameter_name' : 'radius', 
                'neurons': list(analog_PGN_ids[0:9]), 
                'sheet_name' : 'PGN'
            }), 
            fig_param={'dpi' : 100,'figsize': (80,8)}, 
            plot_file_name="SizeTuning_Grating_PGN_10.png"
        ).plot({
            '*.y_lim':(0,100), 
            '*.x_ticks':[0.1, 1, 2, 4, 8], 
            '*.x_scale':'linear',
    ...
    if analog_ids: # V1
        ...
        PlotTuningCurve(
            ...
            fig_param={'dpi' : 100,'figsize': (8,8)}, 
            plot_file_name="SizeTuning_Grating_V1_Exc_L4_0.png"
        ).plot({
            '*.y_lim':(0,50), 
            '*.x_ticks':[0.1, 1, 2, 4, 8], 
            '*.x_scale':'linear',
        ...
        PlotTuningCurve(
            ...
            ParameterSet({
                ...
                'mean': False,
                'parameter_name' : 'radius', 
                'neurons': list(analog_ids[1:2]), 
                'sheet_name' : 'V1_Exc_L4'
            }), 
            fig_param={'dpi' : 100,'figsize': (8,8)}, 
            plot_file_name="SizeTuning_Grating_V1_Exc_L4_1.png"
        ).plot({
            '*.y_lim':(0,50), 
            '*.x_ticks':[0.1, 1, 2, 4, 8], 
            '*.x_scale':'linear',
        ...
        PlotTuningCurve(
            ...
            ParameterSet({
                ...
                'mean': False,
                'parameter_name' : 'radius', 
                'neurons': list(analog_ids[2:3]), 
                'sheet_name' : 'V1_Exc_L4'
            }), 
            fig_param={'dpi' : 100,'figsize': (8,8)}, 
            plot_file_name="SizeTuning_Grating_V1_Exc_L4_2.png"
        ).plot({
            '*.y_lim':(0,50), 
            '*.x_ticks':[0.1, 1, 2, 4, 8], 
            '*.x_scale':'linear',
        ...
        PlotTuningCurve(
            ...
            ParameterSet({
                ...
                'mean': False,
                'parameter_name' : 'radius', 
                'neurons': list(analog_ids[3:4]), 
                'sheet_name' : 'V1_Exc_L4'
            }), 
            fig_param={'dpi' : 100,'figsize': (8,8)}, 
            plot_file_name="SizeTuning_Grating_V1_Exc_L4_3.png"
        ).plot({
            '*.y_lim':(0,50), 
            '*.x_ticks':[0.1, 1, 2, 4, 8], 
            '*.x_scale':'linear',
        ...
        PlotTuningCurve(
            ...
            ParameterSet({
                ...
                'mean': False,
                'parameter_name' : 'radius', 
                'neurons': list(analog_ids[4:5]), 
                'sheet_name' : 'V1_Exc_L4'
            }), 
            fig_param={'dpi' : 100,'figsize': (8,8)}, 
            plot_file_name="SizeTuning_Grating_V1_Exc_L4_4.png"
        ).plot({
            '*.y_lim':(0,50), 
            '*.x_ticks':[0.1, 1, 2, 4, 8], 
            '*.x_scale':'linear',
...
def plot_overview( data_store, analog_Xon_ids, analog_Xoff_ids, analog_PGN_ids=None, analog_ids=None ):
    ...
    if analog_ids:
        OverviewPlot( data_store, ParameterSet({'spontaneous':False, 'sheet_name':'V1_Exc_L4', 'neuron':analog_ids[0], 'sheet_activity':{}}), fig_param={'dpi':100,'figsize':(19,12)}, plot_file_name="V1_Exc_L4_0.png").plot({'Vm_plot.*.y_lim':(-80,-50), 'Conductance_plot.y_lim':(0,40.0), '*.fontsize':7})
